...
class Enemy {
  ...
  isTouching(otherObject){
    if(otherObject instanceof Player){
      if (this.pos[0] < otherObject.pos[0] + (otherObject.width/2) - 25 &&
        this.pos[0] + (this.width/2) - 25 > otherObject.pos[0] &&
        this.pos[1] < otherObject.pos[1] + otherObject.height &&
        this.height + this.pos[1] > otherObject.pos[1]) {

        console.log("I hit a player!");
      }
    } else if(otherObject instanceof Axe){
      if (otherObject.live){
        console.log("AXE!");
      }
    }
